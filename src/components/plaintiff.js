          ...
          >
            <div class="card-body">
              <div className="p-3">
                ...
                <p className="lbl" style={{ width: "60%" }}>
                  Is this Plaintiff the holder of a valid health care concession
                  card , within the meaning of the Social Security 1991 of the
                  Commonwealth? <span style={{ color: "red" }}>*</span>
                </p>
                <div className="form-check form-check-inline">
                  <input
                    className="form-check-input"
  ...
  render() {
    return (
      <>
        <form>
          <div className="p-3">
            <h4>Email Address for Services</h4>
            ...
            <div className="form-check mb-2 mt-5">
              ...
              />
              <label className="form-check-label" for="autoSizingCheck">
                The Registrar has granted leave to omit an Email Address for
                Services
              </label>
            </div>
            ...
            <h4 className="mt-4">Plaintiff(s)</h4>
            <div class="alert alert-info my-3 mb-5" role="alert">
              <div className="row">
                ...
                <div className="col-11">
                  <strong>
                    <p>
                      Add/remove plaintiffs as required below. You may add up to
                      30 defendants.
                    </p>
                  </strong>
                  <p>
                    if you need to associate more than 30 plaintiffs with this
                    case, please contact the CITEC Confirm Service Center on
                    1800 773 773 or by email at{" "}
            ...
            >
              <div class="card-body">
                <div className="p-3">
                  ...
                  <p className="lbl" style={{ width: "60%" }}>
                    Is this Plaintiff the holder of a valid health care
                    concession card , within the meaning of the Social Security
                  ...
                  <div className="form-check mb-2 mt-3">
                    ...
                    />
                    <label className="form-check-label" for="autoSizingCheck">
                      The Principal Firm/Solicitor is located outside of
                      Australia
                    </label>
                  </div>
          ...
          >
            <div class="card-header" id="headingOne">
              <p class="mb-0 text-center">
                <i class="fas fa-plus pr-2"></i>Add Another Plaintiff
              </p>
            </div>
          </div>
        </form>
